...
/**
   ...
   This requires keeping both the current value in the parent component (like for a controlled field)
   and a draft value in the field component (local copy of the upstream value).
